...
d=/dev/disk/by-id/wwn-0x5001b448b446eeb9
d=/dev/disk/by-id/ata-SanDisk_Ultra_II_240GB_160814802527
...
$p mklabel msdos
add_offset $(( 1024 * 1024 ))
mp $(( (1024*1024*1024) * 1  )) BOOT
mp $(( (1024*1024)      * 512)) WINBOOT
mp $(( (1024*1024*1024) * 12 )) UDF
me
ml $(( (1024*1024*1024) * 24 )) Android
ml $(( (1024*1024*1024) * 42 )) Win10
ml $(( (1024*1024*1024) * 12 )) FreeBSD
:
mlx crypt_lvm
:
$p unit s print
